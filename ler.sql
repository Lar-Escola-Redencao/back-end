...
CREATE TABLE unidade (
    ...
    dias_funcionamento VARCHAR(150) NOT NULL, -- ideia é salvar a partir de vários checkbox e no banco "SEG;TER;QUA;QUI;SEX", tratando depois no front "de Segunda a Sexta"
    horario_abertura TIME NOT NULL,
    horario_fechamento TIME NOT NULL,
    idade_min INT NOT NULL,
    idade_max INT NOT NULL,
    cor_hex VARCHAR(7) DEFAULT '#F5F5F5', -- cor do círculo na exibição de unidades     
    imagem VARCHAR(255)
);
...
-- 19. Para guardar os tokens de recuperação de senha
CREATE TABLE token_recuperacao (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    token VARCHAR(255) NOT NULL UNIQUE,
    data_expiracao DATETIME NOT NULL,
    id_membro INT NOT NULL,
    CONSTRAINT fk_tr_membro FOREIGN KEY (id_membro) REFERENCES membro(id) ON DELETE CASCADE
);
...
-- 20. Tabela central de revisões do Envers (Obrigatória)
...
INSERT INTO membro (nome_completo, email, senha, cpf, endereco, telefone, id_papel) VALUES  -- senha adm: admin123
('Administrador Master', 'admin@larredencao.org.br', '$2a$12$HJD3al2Lt3WH5kbpzdqDBuBa21wex7CI/1vBnilmGZQr7XHcemvKG', '00000000000', 'Sede - São José', '(16) 99999-9999', 1),
('monitor', 'monitor@larredencao.org.br', '$2a$12$S4LMo.5rgQRsRh8fZMHkTu181/C6xh44w6hEul4ocpnHXY2Hz50SO', '10000000000', 'Sede - São José', '(16) 99999-9999', 2);

-- INSERT INTO unidade (nome, endereco, telefone, email, dias_funcionamento, horario_abertura, horario_fechamento, idade_min, idade_max, cor_hex) VALUES 
-- ('Sede - São José', 'Av. Francisco Sampaio Peixoto, 372', '(16) 3322-6923', 'larescolaredencaosede@gmail.com', 'SEG;TER;QUA;QUI;SEX', '06:00:00', '18:00:00', 6, 14, '#3A7D2C'), 
-- ('Bezerra de Menezes - Yolanda', 'Av. Valdomiro Blundi, 519 - Yolanda Ópice', '(00) 0000-0000', 'lerbezerra@gmail.com', 'SEG;TER;QUA;QUI;SEX', '06:00:00', '18:00:00', 6, 14, '#092E5E'), 
-- ('SOS Bombeiros - Vila Xavier', 'Rua Cândido Portinari, 123 - Jardim Veridiana - Vl. Xavier', '(16) 3335-8969', 'sosbomb@gmail.com', 'SEG;TER;QUA;QUI;SEX', '06:00:00', '18:00:00', 6, 14, '#C31F26'); 

INSERT INTO rede_social (nome, url, icone, ativo) VALUES
('Facebook', 'https://https://www.facebook.com/larescolaredencaoararaquara/?locale=pt_BR', '/images/redes-sociais/facebook.svg', TRUE),
('Instagram', 'https://https://www.instagram.com/lar_escolaredencao/', '/images/redes-sociais/instagram.svg', TRUE),
('LinkedIn', 'https://www.linkedin.com/', '/images/redes-sociais/linkedIn.svg', FALSE),
('TikTok', 'https://www.tiktok.com/', '/images/redes-sociais/tiktok.svg', FALSE),
('WhatsApp', 'https://www.whatsapp.com/', '/images/redes-sociais/whatsapp.svg', FALSE),
('YouTube', 'https://www.youtube.com/', '/images/redes-sociais/youtube.svg', FALSE);