...
public class UnidadeController {
    ...
    public Unidade criarUnidade(@Valid @ModelAttribute CriarUnidadeDTO criarUnidadeDTO) {
        return unidadeService.criarUnidade(criarUnidadeDTO);
    }

    @PutMapping(value = "/{id}", consumes = "multipart/form-data")
    public Unidade atualizarUnidade(@PathVariable("id") Integer id, @Valid @ModelAttribute AtualizarUnidadeDTO atualizarUnidadeDTO) {
